...
from parser import parse_frontmatter, markdown_to_html, get_post_date
from templates import post_template, index_template
...
def ensure_directories():
    ...
    dirs = ['posts', 'output', 'output/posts', 'output/assets', 'output/assets/js', 'output/images', 'images', 'assets', 'assets/js']
...
def build_site():
    ...
    for post_file in sorted(posts_dir.glob('*.md')):
        try:
            ...
            # Create post HTML
            post_html = post_template(title, html_content, date, description, keywords, author, image)
